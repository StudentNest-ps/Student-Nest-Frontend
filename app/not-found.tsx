          ...
          <>
            <div className="relative w-64 h-64 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <svg width="180" height="180" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="50" cy="50" r="40" stroke="#103c39" strokeWidth="2" strokeLinecap="round" />
                  <path d="M50 20 L50 50 L70 60" stroke="#103c39" strokeWidth="2" strokeLinecap="round" />
                  <path d="M30 30 L70 70" stroke="#e3f1f0" strokeWidth="8" strokeLinecap="round" />
                  <path d="M70 30 L30 70" stroke="#e3f1f0" strokeWidth="8" strokeLinecap="round" />
                </svg>
              </div>
            </div>
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
              Oops! It seems like you&apos;ve ventured into uncharted territory. The page you&apos;re looking for doesn&apos;t exist or
              has been moved.
            </p>
