...
import { apartmentListings, Apartment } from '../data/listings';
...
export default function ApartmentDetailPage() {
  ...
  useEffect(() => {
    ...
    const foundApartment = apartmentListings.find((apt) => apt.id === id);
    setApartment(foundApartment || null);
    setLoading(false);

    if (foundApartment) {
      const date = new Date(foundApartment.availableFrom);
      setFormattedDate(
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span>
                    Available from: <strong>{formattedDate}</strong>
                  </span>
                </div>
