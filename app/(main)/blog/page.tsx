...
const blogPosts = [
  {
    ...
    excerpt: "Egestas viverra nunc vestibulum et placerat condimentum tincidunt commodo sem.",
    category: "Relocation",
    readTime: "1 min read",
  ...
  },
  {
    ...
    excerpt: "Ultrices lectus, purus praesent volutpat vitae et consequat tellus commodo magna.",
  ...
  },
  {
    ...
    excerpt: "Egestas viverra nunc vestibulum et placerat vitae tincidunt commodo sem.",
    category: "Guest experience",
    readTime: "3 min read",
  ...
  },
  {
    ...
    excerpt: "Ultrices lectus, purus praesent volutpat vitae et consequat tellus.",
  ...
  },
  {
    ...
    excerpt: "Egestas purus aliquet integer a elit sagittis nisi, arcu sagittis nisi.",
    category: "Remote working",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "Discover how urban living is evolving with innovative design solutions.",
  ...
  },
  {
    ...
    excerpt: "How the shift to remote work is changing where and how we choose to live.",
    category: "Remote working",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "A journey through the lesser-known architectural wonders of London.",
...
const carouselItems = [
  {
    ...
    subtitle: "Vel morbi integer pulvinar morbi quis amet eu. In nunc facilisi potion interdum, consectetur cursus.",
  ...
  },
  {
    ...
    subtitle: "Professional property management services to help you earn more with less hassle.",
    image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2073&auto=format&fit=crop",
  },
  {
    id: 3,
    title: "Discover London's best neighborhoods",
    subtitle: "Explore the most sought-after areas for property investment and living in London.",
    image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=2070&auto=format&fit=crop",
  },
]
...
export default function BlogPage() {
  ...
  const filteredPosts = blogPosts.filter((post) => {
    // Filter by category
    if (activeCategory !== "View all" && post.category.toLowerCase() !== activeCategory.toLowerCase()) {
      return false
    }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-4 py-6 bg-transparent">

        </div>
      </motion.div>

      {/* Category Tabs */}
      <CategoryTabs activeCategory={activeCategory} setActiveCategory={setActiveCategory} searchQuery={searchQuery} setSearchQuery={setSearchQuery} />
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link href="/blog/trending" className="text-primary flex items-center group">
              <span>View all</span>
            ...
            {filteredPosts.length > 0 ? (
              ...
              >
                {filteredPosts.slice(0, visiblePosts).map((post, index) => (
                  <motion.div key={post.id} variants={fadeInUp} custom={index} className="group">
                    <Link href={`/blog/${post.id}`} className="block">
